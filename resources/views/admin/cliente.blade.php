...
@section('contenido')
<!-- Content -->
<h4 class="fw-bold py-2"><span class="text-muted fw-light">Admin /</span> Lista De Clientes   ({{App\Models\Cliente::count();}})</h4>
<button class="btn btn-primary btn-sm:" data-bs-toggle="modal" data-bs-target="#regisModal">Añadir Cliente</button>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route("admin.cliente.guardar")}}" method="POST">
                ...
                <div class="mb-3 col-md-4">
                    <label class="form-label" for="menbresia">Menbresia</label>
                    <select id="menbresia" name="menbresia">
                        <option value="Vip">Vip</option>
                        <option value="Vip+">Vip+</option>
                        <option value="Vip Premiun">Vip Premiun</option>
                      </select>
                </div>
        ...
        <table id='tabla' class="table table-bordered border-secundary table-sm table-striped w-100">
            <thead class="table-light">
                <tr>
                    ...
                    <th class="text-center">Menbresia</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{$item->menbresia}}</td>
                    <td>
                        ...
                        <a href="{{route("admin.cliente.eliminar",$item->id)}}" class="btn btn-danger btn-san"><i class="fa-solid fa-trash-can"></i></a>
                        <a href="" data-bs-toggle="modal" data-bs-target="#exampleModaldas{{$item->cedula}}" class="btn btn-success btn-san"><i class="fa-solid fa-magnifying-glass"></i></a>
                            ...
                            <div class="modal fade" id="exampleModal{{$item->cedula}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                        <form action="{{ route("admin.cliente.editar", $item->id) }}"method="POST">
                                            @method('PUT')
                                            @csrf
                                            <div class="mb-3 col-md-5">
                                                <label class="form-label" for="cedula">Cedula</label>
                                            ...
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="menbresia">Menbresia</label>
                                                <select id="menbresia" name="menbresia" value="{{$item->menbresia}}">
                                                    <option value="Vip">Vip</option>
                                                    <option value="Vip+">Vip+</option>
                                                    <option value="Vip Premiun">Vip Premiun</option>
                                                  </select>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="menbresia">Mebresia</label>
                                                <input type="text" class="form-control" id="menbresia" name="menbresia" placeholder="menbresia" value="{{$item->menbresia}}" readonly/>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                            </div>
